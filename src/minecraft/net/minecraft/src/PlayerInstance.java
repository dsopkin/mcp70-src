...
class PlayerInstance
{
    ...
    public void func_73252_b(EntityPlayerMP par1EntityPlayerMP)
    {
        ...
        par1EntityPlayerMP.field_71135_a.func_72567_b(new Packet51MapChunk(PlayerManager.func_72692_a(field_73265_a).getChunkFromChunkCoords(field_73264_c.chunkXPos, field_73264_c.chunkZPos), true, 0));
