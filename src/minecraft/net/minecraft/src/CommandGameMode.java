...
public class CommandGameMode extends CommandBase
{
    ...
    {
        if (par2Str.equalsIgnoreCase(EnumGameType.SURVIVAL.func_77149_b()) || par2Str.equalsIgnoreCase("s"))
        {
            return EnumGameType.SURVIVAL;
        }

        if (par2Str.equalsIgnoreCase(EnumGameType.CREATIVE.func_77149_b()) || par2Str.equalsIgnoreCase("c"))
        {
            return EnumGameType.CREATIVE;
        }

        if (par2Str.equalsIgnoreCase(EnumGameType.ADVENTURE.func_77149_b()) || par2Str.equalsIgnoreCase("a"))
        {
