...
public class CommandServerWhitelist extends CommandBase
{
    ...
    public void func_71515_b(ICommandSender par1ICommandSender, String par2ArrayOfStr[])
    {
        if (par2ArrayOfStr.length >= 1)
        {
            ...
            {
                par1ICommandSender.func_70006_a(par1ICommandSender.func_70004_a("commands.whitelist.list", new Object[]
                        {
                ...
                par1ICommandSender.func_70006_a(func_71527_a(MinecraftServer.func_71276_C().func_71203_ab().func_72388_h().toArray(new String[0])));
                return;
            }
