...
public class FontRenderer
{
    ...
    public int drawStringWithShadow(String par1Str, int par2, int par3, int par4)
    {
        ...
        int i = func_78258_a(par1Str, par2 + 1, par3 + 1, par4, true);
        i = Math.max(i, func_78258_a(par1Str, par2, par3, par4, false));
        return i;
    }
    ...
    public void drawString(String par1Str, int par2, int par3, int par4)
    {
        ...
        func_78258_a(par1Str, par2, par3, par4, false);
    }
    ...
    private void func_78255_a(String par1Str, boolean par2)
    {
        for (int i = 0; i < par1Str.length(); i++)
        {
            ...
            float f = renderCharAtPos(k, c, field_78301_u);

            if (field_78302_t)
            {
                posX++;
                renderCharAtPos(k, c, field_78301_u);
                posX--;
                f++;
            }
    ...
    private int func_78274_b(String par1Str, int par2, int par3, int par4, int par5, boolean par6)
    {
        ...
        return func_78258_a(par1Str, par2, par3, par5, par6);
    }
    ...
    {
        field_78304_r = par5;
        func_78268_b(par1Str, par2, par3, par4, false);
    }
    ...
    private void func_78268_b(String par1Str, int par2, int par3, int par4, boolean par5)
    {
        ...
        if (as.length > 1)
        {
            ...
            for (int k = 0; k < j; k++)
            {
                ...
                func_78268_b(s2, par2, par3, par4, par5);
        ...
        for (; i < as1.length; i++)
        {
            ...
            if (getStringWidth(s1) >= par4)
            {
                if (s.length() > 0)
                {
                    func_78274_b(s, par2, par3, par4, field_78304_r, par5);
                    par3 += FONT_HEIGHT;
                    s = s1;
                }
                ...
                do
                {
                    ...
                    func_78274_b(s1.substring(0, l - 1), par2, par3, par4, field_78304_r, par5);
                    par3 += FONT_HEIGHT;
                    s1 = s1.substring(l - 1);
                }
