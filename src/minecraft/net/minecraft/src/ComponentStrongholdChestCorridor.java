...
public class ComponentStrongholdChestCorridor extends ComponentStronghold
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        placeBlockAtCurrentPosition(par1World, Block.field_72079_ak.blockID, 5, 3, 1, 1, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72079_ak.blockID, 5, 3, 1, 5, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72079_ak.blockID, 5, 3, 2, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72079_ak.blockID, 5, 3, 2, 4, par3StructureBoundingBox);

        for (int i = 2; i <= 4; i++)
        {
            placeBlockAtCurrentPosition(par1World, Block.field_72079_ak.blockID, 5, 2, 1, i, par3StructureBoundingBox);
        }
