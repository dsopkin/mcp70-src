...
public class WorldRenderer
{
    ...
    public void setPosition(int par1, int par2, int par3)
    {
        ...
        else
        {
            ...
            RenderItem.renderAABB(AxisAlignedBB.func_72332_a().func_72299_a((float)posXClip - f, (float)posYClip - f, (float)posZClip - f, (float)(posXClip + 16) + f, (float)(posYClip + 16) + f, (float)(posZClip + 16) + f));
            GL11.glEndList();
            markDirty();
            return;
        }
