...
public class CommandHandler implements ICommandManager
{
    ...
    public void func_71556_a(ICommandSender par1ICommandSender, String par2Str)
    {
        ...
        try
        {
            ...
            {
                icommand.func_71515_b(par1ICommandSender, as);
            }
            else
            {
        ...
        {
            par1ICommandSender.func_70006_a((new StringBuilder()).append("\247c").append(par1ICommandSender.func_70004_a("commands.generic.usage", new Object[]
                    {
        ...
        {
            par1ICommandSender.func_70006_a((new StringBuilder()).append("\247c").append(par1ICommandSender.func_70004_a(commandexception.getMessage(), commandexception.func_74844_a())).toString());
        }
        catch (Throwable throwable)
        {
            par1ICommandSender.func_70006_a((new StringBuilder()).append("\247c").append(par1ICommandSender.func_70004_a("commands.generic.exception", new Object[0])).toString());
    ...
    {
        List list = par1ICommand.func_71514_a();
        field_71562_a.put(par1ICommand.func_71517_b(), par1ICommand);
