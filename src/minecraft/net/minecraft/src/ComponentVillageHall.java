...
public class ComponentVillageHall extends ComponentVillage
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        fillWithBlocks(par1World, par3StructureBoundingBox, 5, 0, 1, 7, 0, 3, Block.field_72085_aj.blockID, Block.field_72085_aj.blockID, false);
        placeBlockAtCurrentPosition(par1World, Block.field_72085_aj.blockID, 0, 6, 1, 1, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72085_aj.blockID, 0, 6, 1, 2, par3StructureBoundingBox);
