...
public class BlockTripWire extends Block
{
    ...
    private void func_72147_l(World par1World, int par2, int par3, int par4)
    {
        ...
        boolean flag = (i & 1) == 1;
        boolean flag1 = false;
        List list = par1World.getEntitiesWithinAABBExcludingEntity(null, AxisAlignedBB.func_72332_a().func_72299_a((double)par2 + minX, (double)par3 + minY, (double)par4 + minZ, (double)par2 + maxX, (double)par3 + maxY, (double)par4 + maxZ));
    ...
    public static boolean func_72148_a(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4, int par5)
    {
        ...
        if (l == Block.field_72064_bT.blockID)
        {
        ...
        if (l == Block.field_72062_bU.blockID)
        {
