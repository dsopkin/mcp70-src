...
public class BlockFenceGate extends BlockDirectional
{
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int par4)
    {
        ...
        if (i == 2 || i == 0)
        {
            return AxisAlignedBB.func_72332_a().func_72299_a(par2, par3, (float)par4 + 0.375F, par2 + 1, (float)par3 + 1.5F, (float)par4 + 0.625F);
        }
        else
        {
            return AxisAlignedBB.func_72332_a().func_72299_a((float)par2 + 0.375F, par3, par4, (float)par2 + 0.625F, (float)par3 + 1.5F, par4 + 1);
        }
    }
