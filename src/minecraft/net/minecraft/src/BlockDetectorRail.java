...
public class BlockDetectorRail extends BlockRail
{
    ...
    private void setStateIfMinecartInteractsWithRail(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        boolean flag1 = false;
        float f = 0.125F;
        List list = par1World.getEntitiesWithinAABB(net.minecraft.src.EntityMinecart.class, AxisAlignedBB.func_72332_a().func_72299_a((float)par2 + f, par3, (float)par4 + f, (float)(par2 + 1) - f, (float)(par3 + 1) - f, (float)(par4 + 1) - f));
