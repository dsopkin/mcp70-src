...
public class Block
{
    ...
    {
        return AxisAlignedBB.func_72332_a().func_72299_a((double)par2 + minX, (double)par3 + minY, (double)par4 + minZ, (double)par2 + maxX, (double)par3 + maxY, (double)par4 + maxZ);
    }
    ...
    {
        float f = func_71934_m(par2World, par3, par4, par5);
    ...
    static
    {
        ...
        cobblestone = (new Block(4, 16, Material.rock)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stonebrick").func_71849_a(CreativeTabs.field_78030_b);
        ...
        bedrock = (new Block(7, 17, Material.rock)).setBlockUnbreakable().setResistance(6000000F).setStepSound(soundStoneFootstep).setBlockName("bedrock").disableStats().func_71849_a(CreativeTabs.field_78030_b);
        ...
        blockLapis = (new Block(22, 144, Material.rock)).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("blockLapis").func_71849_a(CreativeTabs.field_78030_b);
        ...
        field_72085_aj = (BlockHalfSlab)(new BlockStep(43, true)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stoneSlab");
        field_72079_ak = (BlockHalfSlab)(new BlockStep(44, false)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stoneSlab");
        brick = (new Block(45, 7, Material.rock)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("brick").func_71849_a(CreativeTabs.field_78030_b);
        ...
        cobblestoneMossy = (new Block(48, 36, Material.rock)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stoneMoss").func_71849_a(CreativeTabs.field_78030_b);
        ...
        field_72073_aw = (new BlockOre(56, 50)).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("oreDiamond");
        field_72071_ax = (new BlockOreStorage(57, 24)).setHardness(5F).setResistance(10F).setStepSound(soundMetalFootstep).setBlockName("blockDiamond");
        ...
        stoneOvenIdle = (new BlockFurnace(61, false)).setHardness(3.5F).setStepSound(soundStoneFootstep).setBlockName("furnace").setRequiresSelfNotify().func_71849_a(CreativeTabs.field_78031_c);
        ...
        oreRedstone = (new BlockRedstoneOre(73, 51, false)).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("oreRedstone").setRequiresSelfNotify().func_71849_a(CreativeTabs.field_78030_b);
        ...
        torchRedstoneActive = (new BlockRedstoneTorch(76, 99, true)).setHardness(0.0F).setLightValue(0.5F).setStepSound(soundWoodFootstep).setBlockName("notGate").setRequiresSelfNotify().func_71849_a(CreativeTabs.field_78028_d);
        ...
        netherBrick = (new Block(112, 224, Material.rock)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("netherBrick").func_71849_a(CreativeTabs.field_78030_b);
        ...
        endPortalFrame = (new BlockEndPortalFrame(120)).setStepSound(soundGlassFootstep).setLightValue(0.125F).setHardness(-1F).setBlockName("endPortalFrame").setRequiresSelfNotify().setResistance(6000000F).func_71849_a(CreativeTabs.field_78031_c);
        whiteStone = (new Block(121, 175, Material.rock)).setHardness(3F).setResistance(15F).setStepSound(soundStoneFootstep).setBlockName("whiteStone").func_71849_a(CreativeTabs.field_78030_b);
        ...
        redstoneLampIdle = (new BlockRedstoneLight(123, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("redstoneLight").func_71849_a(CreativeTabs.field_78028_d);
        ...
        field_72090_bN = (BlockHalfSlab)(new BlockWoodSlab(125, true)).setHardness(2.0F).setResistance(5F).setStepSound(soundWoodFootstep).setBlockName("woodSlab");
        field_72092_bO = (BlockHalfSlab)(new BlockWoodSlab(126, false)).setHardness(2.0F).setResistance(5F).setStepSound(soundWoodFootstep).setBlockName("woodSlab");
        field_72086_bP = (new BlockCocoa(127)).setHardness(0.2F).setResistance(5F).setStepSound(soundWoodFootstep).setBlockName("cocoa").setRequiresSelfNotify();
        ...
        field_72066_bS = (new BlockEnderChest(130)).setHardness(22.5F).setResistance(1000F).setStepSound(soundStoneFootstep).setBlockName("enderChest").setRequiresSelfNotify().setLightValue(0.5F);
