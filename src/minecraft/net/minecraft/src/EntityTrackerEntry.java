...
public class EntityTrackerEntry
{
    ...
    public void func_73120_a(Packet par1Packet)
    {
        ...
        for (Iterator iterator = field_73134_o.iterator(); iterator.hasNext(); entityplayermp.field_71135_a.func_72567_b(par1Packet))
        {
    ...
    public void func_73116_b(Packet par1Packet)
    {
        ...
        {
            ((EntityPlayerMP)field_73132_a).field_71135_a.func_72567_b(par1Packet);
        }
    }
    ...
    public void func_73117_b(EntityPlayerMP par1EntityPlayerMP)
    {
        ...
        if (d >= (double)(-field_73130_b) && d <= (double)field_73130_b && d1 >= (double)(-field_73130_b) && d1 <= (double)field_73130_b)
        {
            if (!field_73134_o.contains(par1EntityPlayerMP) && func_73121_d(par1EntityPlayerMP))
            {
                ...
                par1EntityPlayerMP.field_71135_a.func_72567_b(packet);
                field_73137_j = field_73132_a.motionX;
                field_73138_k = field_73132_a.motionY;
                field_73135_l = field_73132_a.motionZ;
                ...
                {
                    par1EntityPlayerMP.field_71135_a.func_72567_b(new Packet28EntityVelocity(field_73132_a.entityId, field_73132_a.motionX, field_73132_a.motionY, field_73132_a.motionZ));
                }

                if (field_73132_a.ridingEntity != null)
                {
                    par1EntityPlayerMP.field_71135_a.func_72567_b(new Packet39AttachEntity(field_73132_a, field_73132_a.ridingEntity));
                }
                ...
                if (aitemstack != null)
                {
                    ...
                    {
                        par1EntityPlayerMP.field_71135_a.func_72567_b(new Packet5PlayerInventory(field_73132_a.entityId, i, aitemstack[i]));
                    }
                }
                ...
                if (field_73132_a instanceof EntityPlayer)
                {
                    ...
                    {
                        par1EntityPlayerMP.field_71135_a.func_72567_b(new Packet17Sleep(field_73132_a, 0, MathHelper.floor_double(field_73132_a.posX), MathHelper.floor_double(field_73132_a.posY), MathHelper.floor_double(field_73132_a.posZ)));
                    }
                }
                ...
                if (field_73132_a instanceof EntityLiving)
                {
                    ...
                    for (Iterator iterator = entityliving.getActivePotionEffects().iterator(); iterator.hasNext(); par1EntityPlayerMP.field_71135_a.func_72567_b(new Packet41EntityEffect(field_73132_a.entityId, potioneffect)))
                    {
