    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        switch (roomType)
        {
            ...
            case 0:
                ...
                placeBlockAtCurrentPosition(par1World, Block.field_72079_ak.blockID, 0, 4, 1, 4, par3StructureBoundingBox);
                placeBlockAtCurrentPosition(par1World, Block.field_72079_ak.blockID, 0, 4, 1, 5, par3StructureBoundingBox);
                placeBlockAtCurrentPosition(par1World, Block.field_72079_ak.blockID, 0, 4, 1, 6, par3StructureBoundingBox);
                placeBlockAtCurrentPosition(par1World, Block.field_72079_ak.blockID, 0, 6, 1, 4, par3StructureBoundingBox);
                placeBlockAtCurrentPosition(par1World, Block.field_72079_ak.blockID, 0, 6, 1, 5, par3StructureBoundingBox);
                placeBlockAtCurrentPosition(par1World, Block.field_72079_ak.blockID, 0, 6, 1, 6, par3StructureBoundingBox);
                placeBlockAtCurrentPosition(par1World, Block.field_72079_ak.blockID, 0, 5, 1, 4, par3StructureBoundingBox);
                placeBlockAtCurrentPosition(par1World, Block.field_72079_ak.blockID, 0, 5, 1, 6, par3StructureBoundingBox);
                break;
