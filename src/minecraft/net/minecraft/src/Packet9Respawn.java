...
public class Packet9Respawn extends Packet
{
    ...
    public Packet9Respawn(int par1, byte par2, WorldType par3WorldType, int par4, EnumGameType par5EnumGameType)
    {
        ...
        difficulty = par2;
        worldHeight = par4;
        field_73369_d = par5EnumGameType;
    ...
    public void readPacketData(DataInputStream par1DataInputStream) throws IOException
    {
        ...
        field_73369_d = EnumGameType.func_77146_a(par1DataInputStream.readByte());
    ...
    public void writePacketData(DataOutputStream par1DataOutputStream) throws IOException
    {
        ...
        par1DataOutputStream.writeByte(field_73369_d.func_77148_a());
