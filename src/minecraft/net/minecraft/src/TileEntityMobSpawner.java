    ...
    public void updateEntity()
    {
        ...
        else
        {
            ...
            for (int i = 0; i < field_70395_h; i++)
            {
                ...
                int j = worldObj.getEntitiesWithinAABB(entity.getClass(), AxisAlignedBB.func_72332_a().func_72299_a(xCoord, yCoord, zCoord, xCoord + 1, yCoord + 1, zCoord + 1).expand(8D, 4D, 8D)).size();
