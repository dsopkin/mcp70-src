...
public class StatList
{
    ...
    private static void replaceAllSimilarBlocks(StatBase par0ArrayOfStatBase[])
    {
        ...
        replaceSimilarBlocks(par0ArrayOfStatBase, Block.field_72085_aj.blockID, Block.field_72079_ak.blockID);
        replaceSimilarBlocks(par0ArrayOfStatBase, Block.field_72090_bN.blockID, Block.field_72092_bO.blockID);
