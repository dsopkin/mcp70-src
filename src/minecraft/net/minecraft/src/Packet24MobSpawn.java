...
public class Packet24MobSpawn extends Packet
{
    ...
    public void readPacketData(DataInputStream par1DataInputStream) throws IOException
    {
        ...
        field_73490_f = par1DataInputStream.readShort();
        field_73491_g = par1DataInputStream.readShort();
        field_73499_h = par1DataInputStream.readShort();
    ...
    public void writePacketData(DataOutputStream par1DataOutputStream) throws IOException
    {
        ...
        par1DataOutputStream.writeShort(field_73490_f);
        par1DataOutputStream.writeShort(field_73491_g);
        par1DataOutputStream.writeShort(field_73499_h);
