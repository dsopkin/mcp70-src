...
public class ItemPickaxe extends ItemTool
{
    ...
    public boolean canHarvestBlock(Block par1Block)
    {
        ...
        if (par1Block == Block.field_72071_ax || par1Block == Block.field_72073_aw)
        {
    ...
    static
    {
        blocksEffectiveAgainst = (new Block[]
                {
                    Block.cobblestone, Block.field_72085_aj, Block.field_72079_ak, Block.stone, Block.sandStone, Block.cobblestoneMossy, Block.oreIron, Block.blockSteel, Block.oreCoal, Block.blockGold,
                    Block.oreGold, Block.field_72073_aw, Block.field_72071_ax, Block.ice, Block.netherrack, Block.oreLapis, Block.blockLapis, Block.oreRedstone, Block.oreRedstoneGlowing, Block.rail,
