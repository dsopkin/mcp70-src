...
public class ItemDye extends Item
{
    ...
    public boolean func_77648_a(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        if (par1ItemStack.getItemDamage() == 15)
        {
            ...
            if (i == Block.field_72086_bP.blockID)
            {
                if (!par3World.isRemote)
                {
        ...
        else if (par1ItemStack.getItemDamage() == 3)
        {
            ...
            if (j == Block.wood.blockID && BlockLog.func_72141_e(l) == 3)
            {
                ...
                {
                    par3World.setBlockWithNotify(par4, par5, par6, Block.field_72086_bP.blockID);

                    if (par3World.getBlockId(par4, par5, par6) == Block.field_72086_bP.blockID)
                    {
                        Block.blocksList[Block.field_72086_bP.blockID].func_71909_a(par3World, par4, par5, par6, par7, par8, par9, par10);
                    }
