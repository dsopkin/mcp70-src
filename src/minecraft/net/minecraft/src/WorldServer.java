...
public class WorldServer extends World
{
    ...
    public Explosion newExplosion(Entity par1Entity, double par2, double par4, double par6, float par8, boolean par9)
    {
        ...
        do
        {
            ...
            {
                ((EntityPlayerMP)entityplayer).field_71135_a.func_72567_b(new Packet60Explosion(par2, par4, par6, par8, explosion.field_77281_g, (Vec3)explosion.func_77277_b().get(entityplayer)));
            }
        }
        while (true);
