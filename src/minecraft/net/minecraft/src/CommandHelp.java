...
public class CommandHelp extends CommandBase
{
    ...
    public void func_71515_b(ICommandSender par1ICommandSender, String par2ArrayOfStr[])
    {
        ...
        catch (NumberInvalidException numberinvalidexception)
        {
            ...
            if (icommand != null)
            {
                throw new WrongUsageException(icommand.func_71518_a(par1ICommandSender), new Object[0]);
            }
            else
            {
        ...
        par1ICommandSender.func_70006_a((new StringBuilder()).append("\2472").append(par1ICommandSender.func_70004_a("commands.help.header", new Object[]
                {
        ...
        for (int l = j * byte0; l < k; l++)
        {
            ...
            par1ICommandSender.func_70006_a(icommand1.func_71518_a(par1ICommandSender));
        }

        if (j == 0)
        {
            par1ICommandSender.func_70006_a((new StringBuilder()).append("\247a").append(par1ICommandSender.func_70004_a("commands.help.footer", new Object[0])).toString());
        }
    }
