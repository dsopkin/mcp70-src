    ...
    public void func_71515_b(ICommandSender par1ICommandSender, String par2ArrayOfStr[])
    {
        if (par2ArrayOfStr.length >= 1)
        {
            ...
            else if (par2ArrayOfStr.length == 1 || par2ArrayOfStr.length == 2)
            {
                ...
                entityplayermp.field_71135_a.func_72569_a(entityplayermp1.posX, entityplayermp1.posY, entityplayermp1.posZ, entityplayermp1.rotationYaw, entityplayermp1.rotationPitch);
