...
public class AxisAlignedBB
{
    ...
    {
        return func_72332_a().func_72299_a(minX + par1, minY + par3, minZ + par5, maxX + par1, maxY + par3, maxZ + par5);
    }
    ...
    {
        return func_72332_a().func_72299_a(minX, minY, minZ, maxX, maxY, maxZ);
    }
