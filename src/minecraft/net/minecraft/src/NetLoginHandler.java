...
public class NetLoginHandler extends NetHandler
{
    ...
    public NetLoginHandler(MinecraftServer par1MinecraftServer, Socket par2Socket, String par3Str) throws IOException
    {
        ...
        field_72541_j = "";
        field_72542_k = null;
        field_72534_f = par1MinecraftServer;
    ...
    {
        field_72543_h = par1Packet2ClientProtocol.func_73454_f();
        ...
        if (par1Packet2ClientProtocol.func_73453_d() != 39)
        {
            if (par1Packet2ClientProtocol.func_73453_d() > 39)
            {
    ...
    {
        return par0NetLoginHandler.field_72534_f;
    }
