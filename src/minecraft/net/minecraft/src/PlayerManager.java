...
public class PlayerManager
{
    ...
    public void func_72693_b()
    {
        ...
        {
            WorldProvider worldprovider = field_72701_a.worldProvider;
    ...
    {
        ArrayList arraylist = new ArrayList(par1EntityPlayerMP.field_71129_f);
        int i = 0;
        int j = field_72698_e;
        ...
        par1EntityPlayerMP.field_71129_f.clear();

        if (arraylist.contains(chunkcoordintpair))
        {
            par1EntityPlayerMP.field_71129_f.add(chunkcoordintpair);
        }
        ...
        for (int k1 = 1; k1 <= j * 2; k1++)
        {
            for (int i2 = 0; i2 < 2; i2++)
            {
                ...
                for (int j2 = 0; j2 < k1; j2++)
                {
                    ...
                    {
                        par1EntityPlayerMP.field_71129_f.add(chunkcoordintpair1);
                    }
                }
            }
        }
        ...
        for (int l1 = 0; l1 < j * 2; l1++)
        {
            ...
            {
                par1EntityPlayerMP.field_71129_f.add(chunkcoordintpair2);
            }
        }
    }
