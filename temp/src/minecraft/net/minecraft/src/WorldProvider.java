...
//            Block, BlockGrass, MathHelper, Vec3, 
//            Vec3Pool, WorldProviderHell, WorldProviderSurface, WorldProviderEnd, 
...
public abstract class WorldProvider
{
    ...
    {
        if(field_76579_a.func_72912_H().func_76067_t() == WorldType.field_77138_c)
        {
            field_76578_c = new WorldChunkManagerHell(BiomeGenBase.field_76772_c, 0.5F, 0.5F);
        } else
        {
            field_76578_c = new WorldChunkManager(field_76579_a);
        }
    }

    public IChunkProvider func_76555_c()
    {
        if(field_76577_b == WorldType.field_77138_c)
        {
            return new ChunkProviderFlat(field_76579_a, field_76579_a.func_72905_C(), field_76579_a.func_72912_H().func_76089_r());
        } else
        {
            return new ChunkProviderGenerate(field_76579_a, field_76579_a.func_72905_C(), field_76579_a.func_72912_H().func_76089_r());
        }
    }
    ...
    {
        return field_76577_b != WorldType.field_77138_c ? 64 : 4;
    }

    public boolean func_76564_j()
    {
        return field_76577_b != WorldType.field_77138_c && !field_76576_e;
    }

    public double func_76565_k()
    {
        return field_76577_b != WorldType.field_77138_c ? 0.03125D : 1.0D;
    }
