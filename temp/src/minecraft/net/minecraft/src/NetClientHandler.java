...
//            NetHandler, MapStorage, TcpConnection, MemoryConnection, 
//            IntegratedServer, Session, IntegratedServerListenThread, NetworkManager, 
//            Packet253ServerAuthData, CryptManager, Packet252SharedKey, Packet205ClientCommand, 
//            PlayerControllerMP, StatList, StatFileWriter, WorldClient, 
//            WorldSettings, Packet1Login, EntityClientPlayerMP, GuiDownloadTerrain, 
//            Packet204ClientInfo, GameSettings, Packet21PickupSpawn, EntityItem, 
//            ItemStack, Packet23VehicleSpawn, EntityMinecart, EntityPlayer, 
...
//            EntityEnderCrystal, EntityFallingSand, Entity, EntityLiving, 
...
//            Packet34EntityTeleport, Packet30Entity, Packet35EntityHeadRotation, Packet29DestroyEntity, 
//            Packet10Flying, AxisAlignedBB, Packet52MultiBlockChange, Packet51MapChunk, 
//            Chunk, WorldProviderSurface, Packet53BlockChange, GuiDisconnected, 
//            Packet255KickDisconnect, Packet22Collect, EntityPickupFX, EffectRenderer, 
//            GuiIngame, Packet3Chat, GuiNewChat, Packet18Animation, 
//            EntityCrit2FX, Packet17Sleep, Packet24MobSpawn, EntityList, 
...
//            Packet100OpenWindow, InventoryBasic, EntityPlayerSP, Container, 
//            TileEntityFurnace, TileEntityBrewingStand, TileEntityDispenser, MathHelper, 
//            NpcMerchant, Packet103SetSlot, GuiContainerCreative, CreativeTabs, 
//            Slot, Packet106Transaction, Packet104WindowItems, Packet130UpdateSign, 
//            TileEntitySign, Packet132TileEntityData, TileEntityMobSpawner, Packet105UpdateProgressbar, 
//            Packet5PlayerInventory, Packet54PlayNoteBlock, Packet55BlockDestroy, Packet56MapChunks, 
//            Packet70GameEvent, EnumGameType, GuiWinGame, GuiScreenDemo, 
//            KeyBinding, Packet131MapData, Item, ItemMap, 
//            MapData, Packet61DoorChange, Packet200Statistic, Packet41EntityEffect, 
//            PotionEffect, Packet42RemoveEntityEffect, Packet201PlayerInfo, GuiPlayerInfo, 
//            Packet0KeepAlive, Packet202PlayerAbilities, PlayerCapabilities, Packet203AutoComplete, 
//            GuiChat, Packet62LevelSound, Packet250CustomPayload, TexturePackList, 
//            GuiYesNo, NetClientWebTextures, StringTranslate, GuiMerchant, 
//            MerchantRecipeList, IMerchant, Packet, Packet101CloseWindow
...
public class NetClientHandler extends NetHandler
{
        ...
        throws IOException
    {
        field_72554_f = false;
        field_72561_j = false;
        field_72558_b = new MapStorage(null);
    ...
    public void func_72470_a(Packet253ServerAuthData p_72470_1_)
    {
        ...
        java.security.PublicKey publickey = p_72470_1_.func_73376_f();
    ...
    public void func_72511_a(Packet23VehicleSpawn p_72511_1_)
    {
        ...
        if(obj != null)
        {
            obj.field_70118_ct = p_72511_1_.field_73524_b;
            obj.field_70117_cu = p_72511_1_.field_73525_c;
            obj.field_70116_cv = p_72511_1_.field_73522_d;
            obj.field_70177_z = 0.0F;
            obj.field_70125_A = 0.0F;
            ...
            if(aentity != null)
            {
                ...
                for(int k = 0; k < j; k++)
                {
                    ...
                    entity2.field_70157_k += i;
                }

            }
            obj.field_70157_k = p_72511_1_.field_73526_a;
    ...
    public void func_72498_a(Packet10Flying p_72498_1_)
    {
        ...
        double d1 = ((EntityPlayer) (entityclientplayermp)).field_70163_u;
        double d2 = ((EntityPlayer) (entityclientplayermp)).field_70161_v;
        float f = ((EntityPlayer) (entityclientplayermp)).field_70177_z;
        float f1 = ((EntityPlayer) (entityclientplayermp)).field_70125_A;
        ...
        p_72498_1_.field_73545_a = ((EntityPlayer) (entityclientplayermp)).field_70165_t;
        p_72498_1_.field_73543_b = ((EntityPlayer) (entityclientplayermp)).field_70121_D.field_72338_b;
        p_72498_1_.field_73544_c = ((EntityPlayer) (entityclientplayermp)).field_70161_v;
        p_72498_1_.field_73541_d = ((EntityPlayer) (entityclientplayermp)).field_70163_u;
        ...
        if(!field_72561_j)
        {
            ...
            field_72561_j = true;
            field_72563_h.func_71373_a(null);
        }
    }
    ...
    public void func_72492_a(Packet255KickDisconnect p_72492_1_)
    {
        ...
        field_72554_f = true;
        field_72563_h.func_71403_a(null);
    ...
    {
        if(p_72545_1_ == field_72563_h.field_71439_g.field_70157_k)
        {
            return field_72563_h.field_71439_g;
        } else
        {
            return field_72564_i.func_73024_a(p_72545_1_);
        }
    }
    ...
    {
        Explosion explosion = new Explosion(field_72563_h.field_71441_e, null, p_72499_1_.field_73616_a, p_72499_1_.field_73614_b, p_72499_1_.field_73615_c, p_72499_1_.field_73612_d);
    ...
    public void func_72516_a(Packet100OpenWindow p_72516_1_)
    {
        ...
        case 0: // '\0'
            ...
            ((EntityPlayerSP) (entityclientplayermp)).field_71070_bA.field_75152_c = p_72516_1_.field_73431_a;
            break;
        ...
        case 1: // '\001'
            entityclientplayermp.func_71058_b(MathHelper.func_76128_c(((EntityPlayerSP) (entityclientplayermp)).field_70165_t), MathHelper.func_76128_c(((EntityPlayerSP) (entityclientplayermp)).field_70163_u), MathHelper.func_76128_c(((EntityPlayerSP) (entityclientplayermp)).field_70161_v));
            ((EntityPlayerSP) (entityclientplayermp)).field_71070_bA.field_75152_c = p_72516_1_.field_73431_a;
            break;

        case 4: // '\004'
            entityclientplayermp.func_71002_c(MathHelper.func_76128_c(((EntityPlayerSP) (entityclientplayermp)).field_70165_t), MathHelper.func_76128_c(((EntityPlayerSP) (entityclientplayermp)).field_70163_u), MathHelper.func_76128_c(((EntityPlayerSP) (entityclientplayermp)).field_70161_v));
            ((EntityPlayerSP) (entityclientplayermp)).field_71070_bA.field_75152_c = p_72516_1_.field_73431_a;
            break;
    ...
    public void func_72490_a(Packet103SetSlot p_72490_1_)
    {
        ...
        {
            ((EntityPlayer) (entityclientplayermp)).field_71071_by.func_70437_b(p_72490_1_.field_73636_c);
        } else
        {
            boolean flag = false;
            ...
            {
                ItemStack itemstack = ((EntityPlayer) (entityclientplayermp)).field_71069_bz.func_75139_a(p_72490_1_.field_73635_b).func_75211_c();
                ...
                ((EntityPlayer) (entityclientplayermp)).field_71069_bz.func_75141_a(p_72490_1_.field_73635_b, p_72490_1_.field_73636_c);
            } else
            if(p_72490_1_.field_73637_a == ((EntityPlayer) (entityclientplayermp)).field_71070_bA.field_75152_c && (p_72490_1_.field_73637_a != 0 || !flag))
            {
                ((EntityPlayer) (entityclientplayermp)).field_71070_bA.func_75141_a(p_72490_1_.field_73635_b, p_72490_1_.field_73636_c);
            }
        }
    }
    ...
    public void func_72476_a(Packet106Transaction p_72476_1_)
    {
        ...
        if(p_72476_1_.field_73435_a == ((EntityPlayer) (entityclientplayermp)).field_71070_bA.field_75152_c)
        {
    ...
    public void func_72486_a(Packet104WindowItems p_72486_1_)
    {
        ...
        {
            ((EntityPlayer) (entityclientplayermp)).field_71069_bz.func_75131_a(p_72486_1_.field_73426_b);
        } else
        if(p_72486_1_.field_73427_a == ((EntityPlayer) (entityclientplayermp)).field_71070_bA.field_75152_c)
        {
            ((EntityPlayer) (entityclientplayermp)).field_71070_bA.func_75131_a(p_72486_1_.field_73426_b);
        }
    }
    ...
    public void func_72505_a(Packet105UpdateProgressbar p_72505_1_)
    {
        ...
        if(((EntityPlayer) (entityclientplayermp)).field_71070_bA != null && ((EntityPlayer) (entityclientplayermp)).field_71070_bA.field_75152_c == p_72505_1_.field_73634_a)
        {
            ((EntityPlayer) (entityclientplayermp)).field_71070_bA.func_75137_b(p_72505_1_.field_73632_b, p_72505_1_.field_73633_c);
        }
    }
    ...
    {
        EntityClientPlayerMP entityclientplayermp = field_72563_h.field_71439_g;
        ((EntityPlayer) (entityclientplayermp)).field_71075_bZ.field_75100_b = p_72471_1_.func_73350_f();
        ((EntityPlayer) (entityclientplayermp)).field_71075_bZ.field_75098_d = p_72471_1_.func_73346_h();
        ((EntityPlayer) (entityclientplayermp)).field_71075_bZ.field_75102_a = p_72471_1_.func_73352_d();
        ((EntityPlayer) (entityclientplayermp)).field_71075_bZ.field_75101_c = p_72471_1_.func_73348_g();
        ((EntityPlayer) (entityclientplayermp)).field_71075_bZ.func_75092_a(p_72471_1_.func_73347_i());
    }
