...
//            RenderBlocks, MapItemRenderer, Block, ItemStack, 
//            RenderEngine, Tessellator, EntityLiving, EntityPlayer, 
//            RenderHelper, EntityPlayerSP, MathHelper, WorldClient, 
//            OpenGlHelper, Item, ItemMap, EntityClientPlayerMP, 
...
public class ItemRenderer
{
    ...
    public void func_78440_a(float p_78440_1_)
    {
        ...
        if(entityclientplayermp instanceof EntityPlayerSP)
        {
            ...
            float f2 = entityplayersp.field_71164_i + (entityplayersp.field_71155_g - entityplayersp.field_71164_i) * p_78440_1_;
        ...
        if(itemstack != null)
        {
            int j = Item.field_77698_e[itemstack.field_77993_c].func_77620_a(itemstack.func_77960_j(), 0);
        ...
        if(itemstack != null)
        {
            ...
            if(entityclientplayermp.func_71052_bv() > 0)
            {
                ...
                if(enumaction == EnumAction.eat || enumaction == EnumAction.drink)
                {
                    ...
                    f26 = f26 * f26 * f26;
                    float f29 = 1.0F - f26;
                    GL11.glTranslatef(0.0F, MathHelper.func_76135_e(MathHelper.func_76134_b((f15 / 4F) * 3.141593F) * 0.1F) * (float)((double)f21 <= 0.20000000000000001D ? 0 : 1), 0.0F);
